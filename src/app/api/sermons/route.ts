...
const SERMON_SUMMARY_COLUMNS = 'id,title,query,core_message,estimated_minutes,total_chars,is_baseline,obsidian_relative_path,obsidian_synced_at,created_at'
